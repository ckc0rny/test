...
<div className="w3-padding-64 w3-content w3-text-grey" id="contact">
  ...
  <div className="w3-section">
    ...
    <p><i className="fa fa-phone fa-fw w3-text-white w3-xxlarge w3-margin-right" /> Phone: 0820308168</p>
    <p><i className="fa fa-envelope fa-fw w3-text-white w3-xxlarge w3-margin-right"> </i> facebook: Corny Zoneking</p>
    <p><i className="fa fa-envelope fa-fw w3-text-white w3-xxlarge w3-margin-right"> </i> IDLine : 0820308168 </p>
    <p><i className="fa fa-envelope fa-fw w3-text-white w3-xxlarge w3-margin-right"> </i> Email: fewtanakorntv@gmail.com</p>
  </div><br />
